...
public class GraphicOverlay extends View {
    ...
    // Clamp helper as a static method
    private static int clamp(int value, int minV, int maxV) {
    ...
    public abstract static class Graphic {
        ...
        /**
         * Given the {@code zInImagePixel}, update the color for the passed in {@code paint}.
         * The color will be more red if the {@code zInImagePixel} is smaller, or more blue if vice versa.
